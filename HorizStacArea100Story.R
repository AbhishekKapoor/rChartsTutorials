...
# Horizontal Stacked area chart 100% with story

d1=dPlot(y="Year", x="value",data=meltmeansconferences, groups="variable",type="area")
d1$yAxis(type="addCategoryAxis", orderRule="Year")
d1$xAxis(type="addPctAxis")# changed from addMeasureAxis in the regular stacked area 
